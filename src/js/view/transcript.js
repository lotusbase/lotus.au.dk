						...
						'<td>',
							'<div class="dropdown button">',
								...
								'<ul class="dropdown--list">',
									'<li><a href="../view/gene/'+gene+'" title="View gene"><span class="icon-eye">View gene</span></a></li>',
									'<li><a href="../tools/trex?ids='+gene+'"><span class="icon-search">Send gene to Transcript Explorer (TREX)</span></a></li>',
									'<li><a href="../lore1/search-exec?gene='+gene+'&amp;v=3.0" title="Search for LORE1 insertions in this gene"><span class="pictogram icon-leaf"><em>LORE1</em> v3.0</span></a></li>',
								'</ul>',
							'</div>',
						'</td>',
