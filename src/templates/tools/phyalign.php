...
<body class="tools phyalign init-scroll--disabled">
	<?php
		...
		$breadcrumbs->set_page_title('PhyAlign');
	...
	<section class="wrapper">
		...
		<div id="phyalign-tabs">
			...
			<div id="create-alignment">
				<form action="https://www.ebi.ac.uk/Tools/services/rest/clustalo/run/" method="post" id="phyalign-form__submit" class="has-group">
					<div class="cols has-legend dropzone" role="group">
						...
						<div class="dropzone__input hidden">
							<span class="progress"></span>
							<label for="tree-file"><span class="icon-upload icon--big icon--no-spacing">Choose, or drag and drop, a CSV file here</span></label>
							<input type="file" id="tree-file" name="tree_file" class="dropzone__input-file" />
						</div>
						<div class="dropzone__message hidden"></div>
					...
					<div class="toggle hide-first">
						<h3><a href="#" title="Additional configurations">Additional configurations</a></h3>

						<div class="cols has-legend" role="group">
							<p class="legend">General options</p>
			...
			<div id="make-tree">
				...
				<form action="#" method="post" id="phyalign-form__tree" class="has-group dropzone">
					<div class="cols has-legend" role="group">
						...
						<select name="tree-load" id="tree-load" class="col-two">
							<option value="">Select one example tree to load</option>
						...
						<div class="separator full-width"><span>or</span></div>
						<p class="full-width">&hellip;or paste a Newick-format tree in the textarea below, or drag and drop a valid file in this box.</p>
				...
				<div id="phyalign-tree__message"></div>
				<div class="facet controls--visible hidden" id="phyalign-tree">
					<div class="facet__stage">
						...
						<form action="<?php echo WEB_ROOT; ?>/lib/export/svg.pl" method="post" class="hidden image-export__form" id="phyalign-export">
							<input type="hidden" class="svg-data" name="svg_data" />
							<input type="hidden" class="output-format" name="output_format" />
							<input type="hidden" class="filename-prefix" name="filename_prefix" value="phyalign-tree" />
						</form>
					</div>
	...
	<script src="<?php echo WEB_ROOT; ?>/dist/js/plugins/dropzone.min.js"></script>
