...
class MailGenerator {
	...
	public function set_title($new_title) {
		$this->mail_content['title'] = $new_title;
	}

	// Set HTML link
	public function set_html_link($new_html_link) {
		$this->mail_content['html_link'] = $new_html_link;
	}

	// Set header image
	public function set_header_image($new_header_image) {
		$this->mail_content['header_image'] = $new_header_image;
	}

	// Set content
	public function set_content($new_content) {
		$this->mail_content['content'] = $new_content;
	}


	public function get_mail() {
		// Generate mail content
		$spacer = '<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnDividerBlock" style="min-width:100%;">
    <tbody class="mcnDividerBlockOuter">
		...
		$ruler = '<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnDividerBlock" style="min-width:100%;">
    <tbody class="mcnDividerBlockOuter">
        <tr>
...
-->
		...
		$content = $spacer;
		foreach ($this->mail_content['content'] as $key => $c) {
			if(strcmp($c, '*|RULER|*') === 0) {
				$content .= $ruler;
			} else {
				$content .= '<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock"><tbody class="mcnTextBlockOuter"><tr><td valign="top" class="mcnTextBlockInner"><table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextContentContainer"><tbody><tr><td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">';
				$content .= $c;
				$content .= '</td></tr></tbody></table></td></tr></tbody></table>';
			}
		}
		$content .= $spacer;
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>'.strip_tags($this->mail_content['title']).'</title>
            ...
            <td valign="top" class="mcnTextBlockInner">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="366" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:0;">'.$this->mail_content['title'].'</td>
                    </tr>
                </tbody></table>
                ...
                <table align="right" border="0" cellpadding="0" cellspacing="0" width="197" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right:18px; padding-bottom:9px; padding-left:0;">
                            ...
                            '.(isset($this->mail_content['html_link']) ? '<a href="'.$this->mail_content['html_link'].'" target="_blank">View this email in your browser</a>' : '').'
                        </td>
                    </tr>
                </tbody></table>
...
<br>
Please ignore this email if you believe you have received it by mistake.
                        </td>
                    </tr>
                </tbody></table>
