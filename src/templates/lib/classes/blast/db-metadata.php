...
class DBMetadata {
	...
	private $blast_db_metadata_extra = array(
		...
		'20150304_Lj2.5_proteins.fa' => array(
			'category' => 'Lotus japonicus proteins',
		...
		'Gifu_mRNA_illumina_denovo.fa' => array(
			'category' => 'Lotus japonicus transcripts',
		...
		'deepSAGE_TCs.fa' => array(
			'category' => 'Lotus japonicus&mdash;miscellaneous',
		...
		'20160305_MesorhizobiumLoti_MAFF303099_genome.fa' => array(
			'category' => 'Mesorhizoium loti',
			'description' => 'Mesorhizobium loti MAFF303099 genome'
			),
		'20160305_MesorhizobiumLoti_MAFF303099_proteins.fa' => array(
			'category' => 'Mesorhizobium loti',
			'description' => 'Mesorhizobium loti MAFF303099 proteins'
			),
		'20160305_MesorhizobiumLoti_R7A_genome.fa' => array(
			'category' => 'Mesorhizobium loti',
			'description' => 'Mesorhizobium loti R7A genome'
			),
		'20160305_MesorhizobiumLoti_R7A_proteins.fa' => array(
			'category' => 'Mesorhizobium loti',
			'description' => 'Mesorhizobium loti R7A proteins'
			)
	);
	...
	private function removeDB($var) {
		return isset($var['abs_file_path']);
	}
	...
	public function get_metadata($db_file_name = null) {
		...
		if(!isset($db_file_name) || !trim($db_file_name)) {
			return array_filter($this->blast_db_metadata, array(__CLASS__, "removeDB"));
		} else {
			return array_filter($this->blast_db_metadata, array(__CLASS__, "removeDB"))[$db_file_name];
		}
