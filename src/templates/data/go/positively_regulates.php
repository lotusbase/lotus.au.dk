...
<p>The <em>regulates</em> relation has two sub-relations, <em>positively regulates</em> and <em>negatively regulates</em>, to represent these more specific forms of regulation. This means that if A <em>positively regulates</em> X, it is true to say that A <em>regulates</em> X.</p>
<figure>
